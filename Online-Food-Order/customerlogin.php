...
<html>
  ...
  <head>
    <title> Guest Login | FOOD ZILLA </title>
  </head>
...
<?php /*
    <div class="container">
    <div class="jumbotron">
     <h1>Hi Guest,<br> Welcome to <span class="edit"> FOOD ZILLA </span></h1>
     <br>
    ...
    <div class="container" style="margin-top: 4%; margin-bottom: 2%;">
      ...
      <div class="panel panel-primary">
        ...
        <div class="row">
          <div class="form-group col-xs-12">
            <label for="password">
            <span class="text-danger" style="margin-right: 5px;">
            *</span> Password: 
            </label>
...
<div class="container1" id="container1">
	<div class="form-container sign-up-container">
		<form action="#">
			...
			or use your email for regi<span>stration</span>
