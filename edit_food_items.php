...
<div class="col-md-6">
 <div class="form-area" style="padding: 0px 100px 100px 100px;">
        ...
        <br style="clear: both">
          ...
          <div class="form-group">
            <label for="username"><span class="text-danger" style="margin-right: 0px;">*</span> Sub Text: </label>
            <input type="text" class="form-control" id="ds_text" name="ds_text" value=<?php echo $row1['s_text'];  ?> placeholder="Your Food Description" required="">
          </div>
